...
4. Search for "Custom Search API" and enable it for your project.
5. In the left sidebar, click on "Credentials" and create a new API Key.
6. Copy the API Key and use it as the "API Key" in the script's GUI.
7. Next, create a Custom Search Engine by going to Google Custom Search and following the setup instructions.
8. Once your CSE is created, you'll find the CSE ID in the control panel. Use this as the "CSE ID" in the script's GUI.
